...
class DDS:
    ...
    def optimize(self):
        ...
        log_path = os.path.join(lasam.gage_logging_dir(self.gage_id), f"{self.gage_id}.csv")
...
if __name__ == "__main__":
    ...
    lasam.sandbox_config_override = lasam.resolve_sandbox_config(args.sandbox_config)
